...
function AdminViewAllCourses() {
    const [adminAllCourses, setAdminAllCourses] = useState([]);
    ...
    useEffect(() => {
        const fetchAllCourses = async () => {
            try {
                ...
                const response = await axios.get('http://127.0.0.1:8000/api/admins/content-management/courses', {
                    headers: {
                ...
                if (Array.isArray(response.data)) {
                    ...
                    if (response.data.blogs) {
                        coursesData = response.data.blogs;
                ...
                setAdminAllCourses(Array.isArray(coursesData) ? coursesData : []);
            } catch (error) {
    ...
    const confirmDeleteCourse = async () => {
        try {
            ...
            await axios.delete(`http://127.0.0.1:8000/api/admins/content-management/courses/${deleteModal.blog.id}`, {
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
                },
    ...
    return (
        <>
            ...
            <div id="main-container" className="container-fluid py-4" style={{ marginLeft: '260px', maxWidth: 'calc(100% - 280px)' }}>
                                    ...
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <p className="m-0 text-white-50">
                                                {adminAllCourses.length} {adminAllCourses.length === 1 ? 'blog' : 'blogs'} total
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                {adminAllCourses.length === 0 && !error ? (
                                                ...
                                                <td className="text-end pe-4">
                                                    <div className="d-flex justify-content-end gap-2">
                                                        ...
                                                        <button
                                                            ...
                                                            onClick={() => handleDeleteCourse(blog)}
                                                            title="Delete user"
                                                        >
